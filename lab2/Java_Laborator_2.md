...
Для правильной десериализации неообходимо также сохранять название класса, но, поскольку данная лаба не требует считывания из файла назад в память, не стал это реализовывать.
